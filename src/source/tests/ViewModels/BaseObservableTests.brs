...
function MBOT_setField(fieldName, value)
...
function MBOT_setField_multiple()
...
function MBOT_setField_illegalFieldName()
...
function MBOT_checkValidInputs(fieldName, targetNode, targetField, expected)
...
'@Params[""]
'@Params["   "]
function MBOT_checkValidInputs_invalid_nodeIds(nodeId)
...
'@Params["valid1"]
'@Params["valid2"]
function MBOT_checkValidInputs_valid_nodeIds(nodeId)
  targetNode = createObject("roSGNode", "ContentNode")
...
function MBOT_getNodeFieldBindingKey(contextId, nodeId, field, targetField, expected)
...
'@Test on
function MBOT_toggleNotifications_on()
...
'@Test off
function MBOT_toggleNotifications_off()
...
function MBOT_firePendingObserverNotifications_none()
...
'@Params["fieldA", "a"]
'@Params["fieldB", "b"]
function MBOT_firePendingObserverNotifications_one(field1Name, value1)
...
function MBOT_firePendingObserverNotifications_multiple(field1Name, value1, field2Name, value2, field3Name, value3)
...
'@Test no notifications
function MBOT_firePendingBindingNotifications_none()
...
'@Params["fieldA", "a"]
'@Params["fieldB", "b"]
function MBOT_firePendingBindingNotifications_one(field1Name, value1)
...
'@Test multiple notification
'@Params["fieldA", "a", "fieldB", "b", "fieldC", "c"]
function MBOT_firePendingBindingNotifications_multiple(field1Name, value1, field2Name, value2, field3Name, value3)
  'note these come out in a very specific order
...
'@Params["_fieldName", ""]
'@Params["", "functionName"]
function MBOT_observeField(fieldName, functionName)
  m.expectNone(m.observable, "notify")
...
function MBOT_observeField_valid_defaultisSettingInitialValue(fieldName, functionName, value)
  m.expectOnce(m.observable, "notify", [fieldName])
...
function MBOT_observeField_valid(fieldName, functionName, value, isSettingInitialValue, expectedNotifyCount)
...
'@Params["field1", "function1", "#value1"]
'@Params["field1", "function1", "#value1"]
function MBOT_unobserveField_valid_oneObserver_oneField(fieldName, functionName, value)
  m.observable[fieldName] = value
...
function MBOT_unobserveField_valid_multipleObservers_oneField()
...
function MBOT_unobserveField_valid_multipleObservers_multipleFields()
  m.observable["field1"] = 1
  m.observable["field2"] = 2
  m.observable.observeField("field1", "func1", {isSettingInitialValue:false})
  m.observable.observeField("field1", "func2", {isSettingInitialValue:false})
...
'@Params[invalid, invalid]
'@Params[22, invalid]
function MBOT_setContext_invalid(contextId, contextNode)
...
'@Params[invalid]
'@Params[22]
function MBOT_setContext_valid_node_invalidContextId(contextId)
...
function MBOT_setContext_valid_noPendingBindings()
  m.expectOnce(m.observable, "firePendingObserverNotifications")
  m.expectOnce(m.observable, "firePendingBindingNotifications")
  contextNode = MBOT_createContextNode()
...
function MBOT_setContext_valid_pendingBindings_observerOff()
  m.expectNone(m.observable, "firePendingObserverNotifications")
  m.expectNone(m.observable, "firePendingBindingNotifications")
...
function MBOT_setContext_valid_pendingBindings()
  m.expectOnce(m.observable, "firePendingObserverNotifications")
  m.expectOnce(m.observable, "firePendingBindingNotifications")
...
'@Params["field1", "function1", "#value1"]
'@Params["field1", "function1", "#value1"]
function MBOT_unobserveAllFields_valid_oneObserver_oneField(fieldName, functionName, value)
  m.observable[fieldName] = value
  m.observable.observeField(fieldName, functionName, {isSettingInitialValue:false})
  m.assertArrayCount(m.observable.observers, 1)
...
function MBOT_notify_oneObserver_oneField_notificationsEnabled_noContext()
...
function MBOT_notify_oneObserver_oneField_notificationsDisabled_context()
  m.observable["_fieldName"] = "#value"
  contextNode = MBOT_createContextNode()
  m.observable.setContext("1", contextNode)
  m.observable.isBindingNotificationEnabled = false
...
function MBOT_notify_oneObserver_oneField_notificationsEnabled_context()
  m.observable["_fieldName"] = "#value"
  contextNode = MBOT_createContextNode()
  m.observable.setContext("1", contextNode)
  m.observable.isBindingNotificationEnabled = true
...
function MBOT_notify_oneObserver_twoFields_notificationsEnabled_context()
  m.observable["_fieldName"] = "#value"
...
function MBOT_notify_twoObservers_twoFields_notificationsEnabled_context()
  m.observable["_fieldName"] = "#value"
  m.observable["_fieldName2"] = "#value2"
  contextNode = MBOT_createContextNode()
  m.observable.setContext("1", contextNode)
...
'@Test 2 fields, 2 observers, context, notifications
function MBOT_notify_twoObservers_twoFields_notificationsEnabled_context_otherField()
  m.observable["_fieldName"] = "#value"
  m.observable["_fieldName2"] = "#value2"
  contextNode = MBOT_createContextNode()
  m.observable.setContext("1", contextNode)
...
function MBOT_bindField_invalid(fieldName, targetNode, targetField)
...
'@Test - no context set
function MBOT_bindField_noContext()
...
function MBOT_bindField_valid(fieldName, targetNode, targetField)
  contextNode = MBOT_createContextNode()
  m.observable.setContext("1", contextNode)
  m.observable[fieldName] = "value"
  targetNode.id ="nodeId"
...
'@Test 2 fields
function MBOT_bindField_valid_2fields()
  contextNode = MBOT_createContextNode()
  m.observable.setContext("1", contextNode)
  m.observable["f1"] = "v1"
  n1 = createObject("roSGNode", "ContentNode")
...
function MBOT_bindField_valid_1fields_2bindings()
  contextNode = MBOT_createContextNode()
  m.observable.setContext("1", contextNode)
  m.observable["f1"] = "v1"
  n1 = createObject("roSGNode", "ContentNode")
...
'@Params["_fieldName", "#RBSNode", ""]
'@Params["", "#RBSNode", "target_field"]
function MBOT_unbindField_invalid(fieldName, targetNode, targetField)
  m.assertFalse(m.observable.unbindField(fieldName, targetNode, targetField))
end function

'@Test - no context set
function MBOT_unbindField_noContext()
  n1 = createObject("roSGNode", "ContentNode")
  n1.id ="n1"
  m.assertFalse(m.observable.unbindField("fieldName", n1, "targetField"))
end function
...
'@Test 1 fields 2 node targets
function MBOT_unbindField_valid_1fields_2bindings()
  'setup 2 bindings
  contextNode = MBOT_createContextNode()
  m.observable.setContext("1", contextNode)
  m.observable["f1"] = "v1"
...
function MBOT_notifyBinding_noField()
  m.assertFalse(m.observable.notifyBinding("noField"))
end function

'@Test not enabled
function MBOT_notifyBinding_notEnabled()
  contextNode = MBOT_createContextNode()
  m.observable.setContext("1", contextNode)
  m.observable["f1"] = "v1"
  n1 = createObject("roSGNode", "ContentNode")
...
'@Test enabled
function MBOT_notifyBinding_enabled()
  contextNode = MBOT_createContextNode()
  m.observable.setContext("1", contextNode)
  m.observable["f1"] = "v1"
  n1 = createObject("roSGNode", "ContentNode")
...
function MBOT_notifyBinding_enabled_multiple()
  contextNode = MBOT_createContextNode()
  m.observable.setContext("1", contextNode)
  m.observable["f1"] = "v1"
  n1 = createObject("roSGNode", "ContentNode")
...
function MBOT_notifyBinding_enabled_multiple_specificKey()
  contextNode = MBOT_createContextNode()
  m.observable.setContext("1", contextNode)
  m.observable["f1"] = "v1"
  n1 = createObject("roSGNode", "ContentNode")
...
function MBOT_notifyBinding_enabled_multiple_specificKey_notThere()
  contextNode = MBOT_createContextNode()
  m.observable.setContext("1", contextNode)
  m.observable["f1"] = "v1"
  n1 = createObject("roSGNode", "ContentNode")
...
function MBOT_createContextNode()
